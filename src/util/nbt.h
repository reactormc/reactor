        ...
        case NBT_TYPE_COMPOUND: {
            ...
            for (;;) {
                ...
                if (inner_tag->type == NBT_TYPE_END) {
                    ...
                    tag->tag_compound.value = (nbt_tag_t **) NBT_REALLOC(tag->tag_compound.value,
                                                                         (tag->tag_compound.size + 1) *
                                                                         sizeof(nbt_tag_t *));
...
void nbt_tag_compound_append(nbt_tag_t *compound, nbt_tag_t *value) {
    compound->tag_compound.value = NBT_REALLOC(compound->tag_compound.value,
                                               (compound->tag_compound.size + 1) * sizeof(nbt_tag_t *));
